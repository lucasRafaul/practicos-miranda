 ...
 */
final class Version20250714215415 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE puesto (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(50) NOT NULL, salario_minimo NUMERIC(8, 0) NOT NULL, salario_maximo NUMERIC(8, 0) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
